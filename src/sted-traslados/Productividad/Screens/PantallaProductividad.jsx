...
export const PantallaProductividad = () => {
    ...
    return (
        <div className="mt-5">
            <CustomCard title="Productividad" >
                <div className="p-3">
                    ...
                    <DataTable paginator rows={5} rowsPerPageOptions={[5, 10, 25]}
                        ...
                        globalFilterFields={['idPlanificacion', 'coordinador', 'fechaDesde', 'fechaHasta', 'frecuencia', 'estado']} header={header} emptyMessage="No data found.">
                        <Column
                            ...
                            body=
                            {
                                (rowData) => {
                                    ...
                                    return <a onClick={() => navigate(`${rutaServidor}/productividad/detalleProductividad`, { state: { productividad: rowData } })} style={{ color: '#007bff', cursor: 'pointer' }}>{idWithPadding}</a>
                                }
                            }
                            filter
